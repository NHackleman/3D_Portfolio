	...
	return (
		<>
			...
			<motion.p
				...
				className="mt-4 text-secondary text-[17px] pax-w-3xl leading-[30px]"
			>
				I'm a skilled software developer with experience in JavaScript,
				Python, and Powershell scripting, as well as expertise in
				frameworks like React, Node.js, and Flask. I'm a quick learner
